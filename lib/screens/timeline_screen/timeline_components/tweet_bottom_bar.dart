...
//                     .getTweetsList()[index]
//                     .isLiked,
//                 likeCount: Provider.of<TweetsViewModel>(context)
//                     .getTweetsList()[index]
//                     .likeCount,
//                 likeBuilder: (isLiked) {
...
//                   return Provider.of<TweetsViewModel>(context).getTweetsList()[index].likeCount > 0 ? Text(text, style: isLiked?loved:titleName,) : const SizedBox.shrink();
//                 },
//                 onTap: (isLiked) async {
