...
class Tweet {
 Tweet(
     {required this.tweetId, required this.userId, required this.profilePicUrl, required this.username, required this.text, required this.commentCount, required this.retweetCount, required this.likeCount, required this.createdAt, required this.videos, required this.images, required this.comments, required this.likerIds, required this.name, required this.followersCount, required this.followingCount, required this.bio});
...
//-----------------------------------------------------
 ...
 {
  return Tweet(tweetId: jsonData["tweet_id"],
